...
namespace axGB.CPU
{
    public partial class InstructionSet
    {
        ...
        private void OP_0x30(byte   operand) => JumpRelative(operand, Flags.Carry, false);
        ...
        private void OP_0x38(byte   operand) => JumpRelative(operand, Flags.Carry, true);
        ...
        private void OP_0xC0()               => Ret(Flags.Zero, false);
        private void OP_0xC1()               => processor.registers.BC = Pop();
        private void OP_0xC2(ushort operand) => Jump(operand, Flags.Zero, false);
        ...
        private void OP_0xD2(ushort operand) => Jump(operand, Flags.Carry, false);
        ...
        private void OP_0xF2(byte operand)   => processor.registers.A = processor.memory.ReadByte((ushort)(0xFF00 + processor.registers.C));
