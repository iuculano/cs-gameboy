...
namespace axGB
{
    public class RendererWebGPU : IRenderer
    {
        ...
        // Don't like how coupled this is, so this will probably be refactored at some point
        // I really don't want this being part of the renderer itself
        public void GetImguiController()
        {
